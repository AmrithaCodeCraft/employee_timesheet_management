  ...
  return (
    <div className="h-screen w-screen flex items-center justify-center bg-gradient-to-r from-rose-600 to-pink-400">
      <div className="bg-white p-8 rounded-lg shadow-lg w-[400px]">
        ...
        <Label>Role</Label>
        <select className="w-full border p-2 rounded bg-white border-gray-300" onChange={(e) => setForm({ ...form, role: e.target.value })}>
          <option value="employee">Employee</option>
          <option value="admin">Admin</option>
        </select>
        <Button className="w-full mt-4 bg-blue-500 text-white hover:bg-indigo-500 transition" onClick={handleRegister}>
          Sign Up
        </Button>
      </div>
    </div>
